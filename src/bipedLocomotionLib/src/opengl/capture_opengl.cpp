...
/* $Id: capture.c,v 1.1 2005/05/09 09:13:15 aholkner Exp $
...
void captureFrame(void *buf)
{
  char filename[512];
  snprintf(filename, sizeof filename, "%s.png", (char*)buf);
  capture(filename);
}
